        ...
        const detailsHtml = `
            <div class="current-weather__extra-details">
                ...
                <div class="detail-col detail-col--5">
                    <div class="current-weather__detail-item"><span class="detail-item-header"><span>Wschód księżyca</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"/><path d="M12 15v6"/><path d="m9 18 3 3 3-3"/></svg></span><span class="detail-item-value">${data.formattedTimes.moonrise}</span></div>
                    <div class="current-weather__detail-item"><span class="detail-item-header"><span>Zachód księżyca</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"/><path d="M12 9V3"/><path d="m15 6-3-3-3 3"/></svg></span><span class="detail-item-value">${data.formattedTimes.moonset}</span></div>
                </div>
            </div>`;
